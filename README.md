...
Ensure you have Python installed on your system. You can check your version by running:
...
1. **Clone the repository:**
   ```bash
   git clone https://github.com/MaharUzairGull/Econceptions-Assignment.git
...
3. **Install Dependencies:**
   If a `requirements.txt` file is present in the root or scripts folder, install the necessary libraries:
   ```bash
